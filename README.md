...
| [Exgra-Med](https://github.com/duyhominhnguyen/Exgra-Med) | ![](https://img.shields.io/github/stars/duyhominhnguyen/Exgra-Med?style=flat-square) | MERGE Group | NeurIPS 2025 medical vision-language model with multi-graph alignment, released training/evaluation code, checkpoints, and data-efficient Medical VQA / visual-chat pipelines. |
...
| [KEP](https://github.com/MAGIC-AI4Med/KEP) | ![](https://img.shields.io/github/stars/MAGIC-AI4Med/KEP?style=flat-square) | ⭐⭐ B | Computational pathology vision-language pretraining framework from an ECCV 2024 Oral paper. Released training/eval code, inference scripts, datasets, and checkpoint links across OpenPath and Quilt1m tasks. |
| [PathFLIP](https://github.com/cyclexfy/PathFLIP) | ![](https://img.shields.io/github/stars/cyclexfy/PathFLIP?style=flat-square) | ⭐ C+ | AAAI 2026 whole-slide vision-language model for fine-grained caption grounding and instruction-aware pathology analysis. Ships training scripts, docs, and benchmark-oriented pathology code. |
| [sFRC](https://github.com/DIDSR/sfrc) | ![](https://img.shields.io/github/stars/DIDSR/sfrc?style=flat-square) | ⭐ C+ | Safety-oriented toolkit that detects hallucinated regions in AI-reconstructed medical images via patch-wise Fourier Ring Correlation. Includes demos, docs, and Python code for CT/MR restoration evaluation. |
...
| [nnMIL](https://github.com/Luoxd1996/nnMIL) | ![](https://img.shields.io/github/stars/Luoxd1996/nnMIL?style=flat-square) | ⭐⭐ B- | Generalizable multiple-instance-learning framework for computational pathology with experiment planning, training/prediction pipelines, shell workflow wrappers, tutorial docs, and reference bundles for classification and survival tasks. |
...
| [Heimdallr](https://github.com/rod-americo/Heimdallr) | ![](https://img.shields.io/github/stars/rod-americo/Heimdallr?style=flat-square) | ⭐ C+ | Production-oriented radiology MLOps stack for DICOM intake, NIfTI conversion, TotalSegmentator-based segmentation, deterministic quantitative analysis, and outbound DICOM artifact delivery. Ships as a modular Python package with deployment assets. |
| [radiolens](https://github.com/Hilary-Henshaw/radiolens) | ![](https://img.shields.io/github/stars/Hilary-Henshaw/radiolens?style=flat-square) | ⭐ C+ | Chest X-ray pneumonia classifier with FastAPI + Streamlit, DICOM support, certainty tiers, bootstrap external validation, and reproducible training/evaluation code. |
...
| [multiagent-radiology-report](https://github.com/moebouassida/multiagent-radiology-report) | ![](https://img.shields.io/github/stars/moebouassida/multiagent-radiology-report?style=flat-square) | ⭐ C+ | Production-grade radiology report generation stack with 4 LangGraph agents, Grad-CAM explainability, mandatory human review, Docker/Terraform deployment assets, and an MCP server for prior-report retrieval. |
...
| [LuminaMed-AI](https://github.com/CrillyPienaah/luminamed-ai) | ![](https://img.shields.io/github/stars/CrillyPienaah/luminamed-ai?style=flat-square) | ⭐ C+ | Production-style radiology-report platform with multi-agent workflows, patient-friendly explanations, FastAPI/Next.js/Streamlit apps, coding and verification agents, and deployment docs. |
| [MoCoLUS](https://github.com/ahastava/moculus) | ![](https://img.shields.io/github/stars/ahastava/moculus?style=flat-square) | ⭐ C+ | AI-powered point-of-care lung-ultrasound training simulator using ControlNet-guided diffusion to generate photorealistic B-mode and M-mode POCUS frames. Ships web UI, BLE probe support, Docker deployment, and retraining docs. |
...
| [BioAgentics](https://github.com/Agentomics/BioAgentics) | ![](https://img.shields.io/github/stars/Agentomics/BioAgentics?style=flat-square) | ⭐ C+ | Multi-agent biomedical research platform with division-specific roles, plans, pipelines, and tests spanning cancer, Crohn's disease, Tourette syndrome, PANDAS/PANS, and diagnostics workflows. |
...
| [MedGraph-AI](https://github.com/chencyan21/MedGraphAI) | ![](https://img.shields.io/github/stars/chencyan21/MedGraphAI?style=flat-square) | ⭐⭐ B- | LangGraph-based multi-agent medical assistant combining medical Q&A, Qdrant RAG, time-sensitive web retrieval, and reviewer-gated image analysis via FastAPI + Chainlit. |
| [CLARA-Care](https://github.com/Project-CLARA-HBT/CLARA-Care) | ![](https://img.shields.io/github/stars/Project-CLARA-HBT/CLARA-Care?style=flat-square) | ⭐ C+ | Safety-first multi-module medical assistant platform with backend legal guardrails, hybrid retrieval, medication/DDI flows, council-style consultation, and multi-service deployment docs. |
| [clinical_trial_agent](https://github.com/Chrisolande/clinical_trial_agent) | ![](https://img.shields.io/github/stars/Chrisolande/clinical_trial_agent?style=flat-square) | ⭐ C+ | Async LangGraph clinical-trial matcher that retrieves ClinicalTrials.gov studies, scores eligibility, and produces ranked reports with PostgreSQL-backed memory and cache. |
...
| [MAM](https://github.com/yczhou001/MAM) | ![](https://img.shields.io/github/stars/yczhou001/MAM?style=flat-square) | ⭐⭐ B- | ACL 2025 modular multi-agent framework for multimodal medical diagnosis. Orchestrates GP, specialist, radiologist, medical-assistant, and director agents across text, image, audio, and video tasks with end-to-end inference code. |
...
| [Anamnesis](https://github.com/Veta-one/anamnesis) | ![](https://img.shields.io/github/stars/Veta-one/anamnesis?style=flat-square) | ⭐ C+ | Early-release self-hosted PWA for structured personal and family medical records with AI-assisted data entry, document scanning, cross-referencing, PHI encryption, and backend/frontend docs. |
...
| [DeepVariant](https://github.com/google/deepvariant) | ![](https://img.shields.io/github/stars/google/deepvariant?style=flat-square) | ⭐⭐⭐ A- | Google's deep-learning variant caller for WGS, WES, RNA, and long-read genomics, with Docker images, case-study docs, and production-grade pipelines widely used in clinical-genomics workflows. |
...
| [Biomedical Agent](https://github.com/nickzren/biomed-agent) | ![](https://img.shields.io/github/stars/nickzren/biomed-agent?style=flat-square) | ⭐⭐ B- | General-purpose biomedical knowledge assistant that connects to OpenTargets, Monarch, MyGene, MyChem, and MyDisease via MCP, returning confidence, citations, and limitations through CLI and Streamlit interfaces. |
...
| [biocli](https://github.com/youngfly93/biocli) | ![](https://img.shields.io/github/stars/youngfly93/biocli?style=flat-square) | ⭐⭐ B- | Biology workflow CLI and agent runtime for batch gene scanning, tumor cohort briefing, and target discovery. Ships npm releases, smoke tests, reproducible run artifacts, and benchmarked workflow outputs. |
| [OmicsAgent](https://github.com/madhubioinformatics/OmicsAgent) | ![](https://img.shields.io/github/stars/madhubioinformatics/OmicsAgent?style=flat-square) | ⭐ C+ | Local-first multi-omics AI agent with 15 analysis skills spanning genomics, transcriptomics, spatial biology, proteomics, metabolomics, and immune-repertoire workflows. Includes CLI/chat modes, a live demo, and reproducibility bundles. |
